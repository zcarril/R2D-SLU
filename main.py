...
try:
    while(1):
        for scan in lidar.iter_scans():
            ...
            fAng1, fAng2, fAng3, fAng4, fAng5, fAng6, fAng7, fAng8, fAng9, fAng10 = (
                [] for i in range(10))
            lAng1, lAng2, lAng3, lAng4, lAng5, lAng6, lAng7, lAng8, lAng9, lAng10 = (
                [] for i in range(10))
            rAng1, rAng2, rAng3, rAng4, rAng5, rAng6, rAng7, rAng8, rAng9, rAng10 = (
                [] for i in range(10))
            ...
            for i in range(len(main)):
                ...
                if avgDist != None:
                    if i < len(main)-1:
                        if i < 10:
                            mListLeft.append(
                                printSame(avgDist, endLine, thresh))
                        elif i < 20:
                            mListFront.append(
                                printSame(avgDist, endLine, thresh))
                        elif i < 30:
